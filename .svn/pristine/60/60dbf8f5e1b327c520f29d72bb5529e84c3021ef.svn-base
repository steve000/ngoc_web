<template>
    <div class="ZhyiLogisticsBadStock ">
        <div class="top-scroll-section"> 
            ...
            <div class="table-empty-height">
            	<el-table :data="skuTotalStockList" border>
                    ...
                    <el-table-column label="待验库存总量" prop="proxyTotalNum" min-width="100">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="代发待验库存" prop="proxyWaitCheckTotalNum" min-width="110">
                        <template slot-scope="scope">
                            <div class="row-btn-show ">
        ...
        <modal title="代发待验库存详情" v-model="isShowStockDetail" width="60%" class="modelStock">
            ...
            <el-table :data="LocalStockDetail">
                ...
                <el-table-column label="代发代验库存数量">
                    <template slot-scope="scope">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...mapActions(["queryProductInventoryLisy","queryProductDistribution","QueryStockSnList","showPageLoading","hidePageLoading"]),
            refreshPage(){//查询中移物流不良品仓的仓库详情列表
            	let params = {
                    pageNo:this.pageNo,
            ...
            showSnModal(skuId,skuName){//查看串码
