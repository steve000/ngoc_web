    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增组合促销</button>
            </div>
        ...
        <div class="main-section">
            <div class="main-wrapper">
                <purchase-list :flag="flagMsg" @closeEdit="closeEdit" @closeView="closeView"
...
<script>
    ...
    import PurchaseList from '~/components/sales/promotion/combPromotionList'
    export default{
        name: "PurchaseOrder",
        ...
        methods: {
            ...
            createPurchase(){
                this.$router.push(`/sales/promotion/combAdd`)
            },
            showPurchase(val,type){
                console.log(val,type,'index')
                this.type = type;
                this.flagMsg = val;
                console.log(this.type,this.flagMsg,'index')
            },
            onPageRefresh(){
