    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增仓位设置</button>
            </div>
            <el-menu default-active="1">
                <el-menu-item index="1">
                    <i class="iconfont1 iconquanbu icon-quanbu"></i>
                    <div slot="title" @click="showPurchase('-1','all')" class="menu-btn-space">全部仓位</div>
                </el-menu-item>
            </el-menu>
        </div>
...
<script>
    ...
    import PurchaseList from '~/components/stocks/storehouseLocation/storehouseLocationList'
    export default {
        ...
        methods: {
            createPurchase(){
                this.$router.push(`/stock/storehouseLocationAdd`)
            },
