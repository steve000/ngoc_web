    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增盘点单</button>
            </div>
            <el-menu default-active="1">
                ...
                <el-menu-item index="2">
                    ...
                    <div slot="title" @click="showPurchase('1')" class="menu-btn-space">正在盘点</div>
                </el-menu-item>
                <el-menu-item index="3">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('2')" class="menu-btn-space">盘点完成</div>
                </el-menu-item>
...
<script>
    ...
    import PurchaseList from '~/components/stocks/inventory/inventoryList'
    export default {
        name: "inventoryIndex",
