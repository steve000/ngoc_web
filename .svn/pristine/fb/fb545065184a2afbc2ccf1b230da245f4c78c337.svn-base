    ...
    <div class="nprmalPromotion">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton" style="width: 125px;"><i class="el-icon-plus"></i>新增条件组合促销</button>
            </div>
...
<script>
    ...
    import PurchaseList from '~/components/sales/promotion/conGroupPromotionList'
    export default {
        ...
        methods: {
            createPurchase(){
                this.$router.push(`/sales/promotion/conGroupPromotionAdd`)
            },
