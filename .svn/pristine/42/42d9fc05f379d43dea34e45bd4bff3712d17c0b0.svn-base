                    ...
                    <div>
                        ...
                        <div class="displayStyle">
                            <el-form-item label="收款实体" prop="recUserGroupId">
                                <el-select v-model="logisticsCostEntryForm.recUserGroupId"
                                    :multiple="false"
                                    filterable
                                    clearable
                                    size="small"
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions(["userGroupAll","stockLogisticscostAdd","SearchGoodsList","showPageLoading","hidePageLoading"]),
            savePurchase(logisticsCostEntryAdd){
              this.$refs[logisticsCostEntryAdd].validate((valid) => {
                if (valid) {
                  let datas = {}
                  datas = this.logisticsCostEntryForm
                  this.stockLogisticscostAdd(datas).then((res) =>{
                      this.showSuccess("保存成功");
                      this.OnBackLatePage(logisticsCostEntryAdd);
                  })
                } else {
