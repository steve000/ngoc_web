    ...
    <div class='createPurchase-view'>
                    ...
                    <div>
                        ...
                        <div class="displayStyle">
                            <el-form-item label="渠道名称" prop="channelId">
                                <el-select v-model="channelPlanForm.channelId"
                                    :multiple="false"
                                    filterable
                                    clearable
                                    size="small"
        ...
        <div class="content">
            ...
            <div class="content-wrapper" style="padding-left: 20px">
                <channel-planList-add :contractData="contractData" :checkProductList="checkProductList" @validateEmit="validateEmit">
        ...
        this.$refs[channelPlanForm].validate(valid => {
            if (valid) {
                ...
                if (this.contractData.validateEmit) {
                    ...
                    if (goArr) {
                    this.channelplanAdd(datas).then(res => {
