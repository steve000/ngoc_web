    ...
    <div class="nprmalPromotion">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增满减促销</button>
            </div>
...
<script>
    ...
    import PurchaseList from '~/components/sales/promotion/reducePromotionList'
    export default {
        ...
        methods: {
            ...
            createPurchase(){
                this.$router.push(`/sales/promotion/reducePromotionAdd`)
            },
