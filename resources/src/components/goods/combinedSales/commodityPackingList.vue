        ...
        <div class="table-wrapper">
            <el-table :data="commodityPackingList" border :height="tableHeight">
                    ...
                    <template slot-scope="scope">
                      <div class="row-btn-show">
                        <div class="row-show" 
                          ...
                          @click="$router.push({name: `commodityPackingDetails`, params: scope.row})">{{scope.row.packageName ? scope.row.packageName : '--'}}
                        </div>
                        <more-operating 
                ...
                <el-table-column label="组合价（元）" min-width="60">
                    <template slot-scope="scope">
                        <div class="row-show" :title="(Number(scope.row.packagePrice)/100).toFixed(2)">{{scope.row.packagePrice!=null ? (Number(scope.row.packagePrice)/100).toFixed(2) :'--'}}</div>
                    </template>
                </el-table-column>
