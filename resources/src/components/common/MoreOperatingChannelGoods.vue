...
<template>
    <div class="operate-div" title="更多">
        ...
        :popper-class='paddingClass'>
            <div slot="content">
                <div>
                    <el-button type="text" class="operating-button"  @click="changeHistoryFunction">修改历史</el-button>
                </div>
                <div>
               ...
               <!--<div>-->
                   <!--<el-button type="text" class="operating-button"   @click="cancelFunction">取消</el-button>-->
               <!--</div>-->
            </div>
