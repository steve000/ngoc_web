    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增新品推荐</button>
            </div>
            <el-menu default-active="1">
                <el-menu-item index="1">
                    <i class="iconfont1 iconquanbu icon-quanbu"></i>
                    <div slot="title" @click="showPurchase('-1')" class="menu-btn-space">全部新品推荐</div>
                </el-menu-item>
                <el-menu-item index="2">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('1')" class="menu-btn-space">未引进</div>
                </el-menu-item>
                <el-menu-item index="3">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('2')" class="menu-btn-space">已引进</div>
                </el-menu-item>
...
<script>
    ...
    import PurchaseList from '~/components/purchase/vendorSpuList'
    export default {
        name: "vendorSpuIndex",
        ...
        methods: {
            createPurchase(){
                this.$router.push({name: 'vendorSpuAdd', params: {type: 'indexAdd'}})
            },
