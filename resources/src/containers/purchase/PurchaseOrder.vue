    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增采购订单</button>
            </div>
            <el-menu default-active="1">
                ...
                <el-menu-item index="5">
                    ...
                    <div slot="title" @click="showPurchase('2','approveStatus')" class="menu-btn-space">审批中</div>
                </el-menu-item>
                <el-menu-item index="6">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('3','approveStatus')" class="menu-btn-space">已驳回</div>
                </el-menu-item>
                <!--<el-menu-item index="7">-->
                <!--<div class="menu-icon-place-holder"></div>-->
                <!--<div slot="title" @click="showPurchase('4')" class="menu-btn-space">已撤销</div>-->
                <!--</el-menu-item>-->
                <div class="divide-line"></div>
                <el-menu-item index="2">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('1','status')" class="menu-btn-space">待收货</div>
                </el-menu-item>
                <el-menu-item index="3">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('2','status')" class="menu-btn-space">部分收货</div>
                </el-menu-item>
                <el-menu-item index="4">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('3','status')" class="menu-btn-space">已收货</div>
                </el-menu-item>
                <div class="divide-line"></div>
                <el-menu-item index="7">
                    <div class="menu-icon-place-holder"></div>
                    <div slot="title" @click="showPurchase('1','approveStatus')" class="menu-btn-space">草稿</div>
                </el-menu-item>
            </el-menu>
        </div>
