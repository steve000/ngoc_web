    ...
    <div class="content-section">
        <div class="left-section pull-left">
            <div class="add-section" style="margin: 0px">
                <el-button type="primary" @click="addSpecialPrice" class="addmutibar" icon="el-icon-plus" :disabled="false">新增特价政策</el-button>
            </div>
        ...
        <div class="main-section">
            <div class="main-wrapper">
                <special-pricepolicy-list :operationId="operationId"></special-pricepolicy-list>
            </div>
        </div>
    </div>
</template>
...
import SpecialPricepolicyList from "~/components/goods/manage/SpecialPricepolicyList";
...
export default {
  ...
  mounted() {
    this.showGoods("");
    // this.priceSpecialGoodsAdd().then(resp => {});
  },
  methods: {
    // ...mapActions(["priceSpecialGoodsAdd"]),
    addSpecialPrice() {
      this.$router.push({path: `/goods/manage/addSpecialPrice`});
    },
