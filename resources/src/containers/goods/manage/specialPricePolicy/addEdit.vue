...
export default {
  ...
  methods: {
    ...
    editFunction (addFormParams) {
      ...
      // this.priceSpecialGoodsAdd(datas).then(res => {
      //   this.OnBackLatePage()
      // });
      this.$refs[addFormParams].validate((valid) => {
        if (valid) {
            ...
            if (!this.addForm.productList.length || !this.addForm.userGroupList.length) {
              this.$message({
                  type: 'warning',
                  message: '商品清单数据不能为空'
              });
            ...
            // console.log(this.addForm.productList,"查看商品list");
            // console.log(this.addForm.isSalePrice,"零售价");
            // console.log(this.addForm.isVipPrice,"会员价");
            // console.log(this.addForm.isGroupPrice,"团购价");
            if (this.addForm.isSalePrice == true) {
              console.log("11")
            ...
            if (this.addForm.isVipPrice == true) {
              console.log("22")
              this.addForm.productList.forEach((item, index) => {
                if (item.vipPrice < 0) {
                  this.$message({
            ...
            if (this.addForm.isGroupPrice == true) {
              console.log("33")
              this.addForm.productList.forEach((item, index) => {
