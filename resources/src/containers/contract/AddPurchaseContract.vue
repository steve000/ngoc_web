                    ...
                    <div>
                        <div class="displayStyle">
                            <el-form-item label="合同编号：" prop="conNo">
                                <el-input v-model="addPurchaseContractData.conNo" class="row_width" size="small">
                                </el-input>
                            </el-form-item>
                        </div>
                        <div class="displayStyle">
                      ...
                      <div class="displayStyle">
                          <el-form-item label="备注：" prop="remark">
                            <el-input type="textarea" :rows="6" :maxlength="200"
                                      v-model="addPurchaseContractData.remark" placeholder="请输入备注，最多200个字" size="small" style="width:775px;"></el-input>
    ...
    export default {
        ...
        data() {
            ...
            let remark = (rule, value, callback) => {
                if (value.length > 200) {
                    return callback(new Error('字数不能超过200!'));
                } else {
                    return callback();
                }
            }
            return{
                ...
                rules: {
                    ...
                    remark: [{required: true, validator: remark, trigger: 'change'}],
                },
            }
        },
        mounted(){
        ...
        methods:{
            ...mapActions(["purchaseContractAdd","vendorQuerylistbyusergroupid","showPageLoading","hidePageLoading"]),
            // // 表格初始化
            addGoodsMsg(){
            ...
            savePurchase(addPurchaseContractData){
                ...
                if (fun) {
                    ...
                    if (valid) {
                        ...
                        this.purchaseContractAdd(datas).then((res) =>{
                            this.OnBackLatePage(addPurchaseContractData);
                        })
                    } else {
                        this.showWarning("请按照验证规则填写");
                        return false;
                    }
                    });
                }
