    ...
    <div class="create-storage">
        <div class="content">
            ...
            <div class="content-wrapper">
                <el-form label-position="right" label-width="140px" :model="editReceiveCheck" class="topBox"
                         ref="editReceiveCheck">
                    ...
                    <div class="displayStyle">
                        <el-form-item label="收款实体名称：" required>
                            <el-input class="form-input-width"  v-model="editReceiveCheck.receivableGroupName" size="small" disabled></el-input>
                        </el-form-item>
                    </div>
                    <div class="displayStyle">
                        <el-form-item label="对账截止时间：" >
                            <el-input class="form-input-width"  v-model="editReceiveCheck.endTime" size="small" disabled></el-input>
                        </el-form-item>
                    </div>
                    <div class="displayStyle">
                        <el-form-item label="调整金额：" >
                            <el-input class="form-input-width"  v-model="editReceiveCheck.adjustTotal" size="small" type="number"></el-input>
                        </el-form-item>
                    </div>
                    <div class="" style="float: left;">
                        <el-form-item label="备注：">
                                <el-input type="textarea"
                                          ...
                                          :maxlength="200"
                                          v-model="editReceiveCheck.remark" placeholder="请输入备注，200字以内"></el-input>
                            </el-form-item>
                    </div>
                </el-form>
            </div>
        ...
        <div class="btn-section pt20">
            <el-button type="primary" size="small" @click="editReceiveCheckFrom('editReceiveCheck')">提交</el-button>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.receiveCheckInfoFunction();
        },
        methods: {
            ...mapActions(['receiveCheckInfo','receiveCheckEdit','receiveCheckQueryInSettle',"showPageLoading", "hidePageLoading"]),
            // 编辑详情  
            receiveCheckInfoFunction(){
                this.receiveCheckInfo({id: this.getId}).then((resp) => {
                    this.hidePageLoading();
                    console.log(resp,"32142112312");
                    this.editReceiveCheck = resp;
            ...
            editReceiveCheckFrom(formName){
                console.log(this.settleTotalAmount,"含税金额");
                this.postData.billList = this.checkskuList;
                this.postData.id = this.getId;
                this.postData.receiveCheckNo = this.editReceiveCheck.receiveCheckNo;
                this.postData.endTime = this.editReceiveCheck.endTime;
                this.postData.adjustTotal = this.editReceiveCheck.adjustTotal;
                this.postData.remark = this.editReceiveCheck.remark;
                this.submitForm();
            },
            submitForm(){
                        if (this.checkskuList.length <= 0) {
                        ...
                        this.receiveCheckEdit(this.postData).then((resp) => {
                            this.hidePageLoading();
            ...
            getreceiveCheckQueryInSettle(){
                this.receiveCheckQueryInSettle({receivableGroupId: this.editReceiveCheck.receivableGroupId, endTime: this.editReceiveCheck.endTime}).then((resp) => {
