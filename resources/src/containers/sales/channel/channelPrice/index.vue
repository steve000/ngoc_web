    ...
    <div class="purchase">
        <div class="left-section pull-left">
            <div class="add-section">
                <button @click="createPurchase" class="addButton"><i class="el-icon-plus"></i>新增渠道商品</button>
            </div>
...
<script>
    ...
    import PurchaseList from '~/components/sales/channel/channelPriceList'
    export default {
        name: "channelPrice",
        ...
        methods: {
            createPurchase(){
                this.$router.push(`/sales/channel/channelPriceAdd`)
            },
