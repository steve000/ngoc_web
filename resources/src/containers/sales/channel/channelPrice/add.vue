        ...
        <div class="content">
            ...
            <div class="content-wrapper" >
                <el-form label-width="110px" :model="channelPriceForm" :rules="rules" ref="channelPriceForm">
                    ...
                    <div>
                        <div class="displayStyle">
                            <el-form-item label="商品名称" prop="skuId">
                                <el-select v-model="channelPriceForm.skuId"
                                    :multiple="false"
                                    filterable
                                    clearable
                                    size="small"
                        ...
                        <div class="displayStyle">
                          <el-form-item label="渠道价" prop="channelPrice">
                            <el-input type="number" v-number-decimal-only v-model="channelPriceForm.channelPrice" class="row_width" placeholder="请输入渠道价" size="small"></el-input>
                          </el-form-item>
                        </div>
                    </div>
                    ...
                    <div>
                      <div class="displayStyle">
                          <el-form-item label="分配数量" prop="totalCount">
                            <el-input type="number" v-number-decimal-only v-model="channelPriceForm.totalCount" class="row_width" placeholder="请输入分配数量" size="small"></el-input>
                          </el-form-item>
                        </div>
                    </div>
                    <div>
...
export default {
  ...
  methods: {
    ...
    savePurchase(channelPriceForm) {
      this.$refs[channelPriceForm].validate(valid => {
        if (valid) {
          ...
          this.channelpriceAdd(datas).then(res => {
            this.OnBackLatePage(channelPriceForm);
          });
        } else {
    ...
    //点击取消
    OnBackLatePage(channelPriceForm){
        this.$message({
            type: 'success',
            message: `操作成功`
        })
