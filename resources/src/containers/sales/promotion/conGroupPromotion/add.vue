<template>
    <div class='createPurchase-view'>
                    ...
                    <div>
                        ...
                        <div class="displayStyle">
                            <el-form-item label="条件类型：" prop="conditionType">
                                <el-select v-model="conGroupPromotionForm.conditionType" class="row_width" size="small">
                        ...
                        <div class="displayStyle">
                          <el-form-item label-width="0px">
                            <el-checkbox v-model="conGroupPromotionForm.isBillPro">整单满减</el-checkbox>
                          </el-form-item>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <div class="displayStyle">
                            <el-form-item label="业务实体：" prop="userGroupId">
                                <el-select v-model="conGroupPromotionForm.userGroupId"
                                    :multiple="false"
                                    filterable
                                    clearable
                                    size="small"
        ...
        <div class="btn-section pt20">
            <el-button type="primary" @click="savePurchase('conGroupPromotionForm')" size="small">保存</el-button>
            <el-button type="primary" plain size="small" @click="cancelFunction('conGroupPromotionForm')">取消</el-button>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        data() {
            ...
            let conditionType = (rule, value, callback) => {
                if (value === '' || value === undefined) {
                    return callback(new Error('请选择条件类型!'));
                } else {
                    return callback();
                }
            }
            return{
                ...
                rules: {
                    ...
                    conditionType:[{required: true, validator: conditionType, trigger: 'change'}],
                },
            }
        },
        mounted(){
        ...
        methods:{
            ...mapActions(["userGroupAll","conGroupPromotionAdd","SearchGoodsList","showPageLoading","hidePageLoading"]),
                ...
                this.$refs[conGroupPromotionForm].validate((valid) => {
                    if (valid) {
                        ...
                        if (goArr) {
                            ...
                            datas.isBillPro ? datas.isBillPro = 1 : datas.isBillPro = 0
                            this.conGroupPromotionAdd(datas).then((res) =>{
                                this.OnBackLatePage();
                            })
                        }
