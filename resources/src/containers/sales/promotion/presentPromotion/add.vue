            ...
            <div class="content-wrapper" >
                <el-form label-width="110px" :model="presentPromotionForm" ref="presentPromotionForm" :rules="rules">
                    <div>
                        ...
                        <div class="displayStyle">
                          <el-form-item label="">
                            <el-checkbox v-model="presentPromotionForm.isCtrlUseArea">控制赠劵使用范围</el-checkbox>
                          </el-form-item>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <div class="displayStyle">
                            <el-form-item label="业务实体：" prop="userGroupId">
                                <el-select v-model="presentPromotionForm.userGroupId"
                                    :multiple="false"
                                    filterable
                                    clearable
                                    size="small"
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.presentPromotionForm.beginTime = nowDate + ' 00:00:00';
            this.presentPromotionForm.endTime = nowDate + ' 23:59:59';
            this.presentPromotionForm.couponList[0].beginTime = nowDate + ' 00:00:00';
            this.presentPromotionForm.couponList[0].endTime = nowDate + ' 23:59:59';
        },
        computed: {
        },
        methods:{
            ...mapActions(["userGroupAll","presentPromotionAdd","SearchGoodsList","showPageLoading","hidePageLoading"]),
                ...
                this.$refs[presentPromotionForm].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.presentPromotionForm.couponList.length > 0) {
                            ...
                            this.presentPromotionForm.couponList.forEach(item => {
                                ...
                                if (item.needTotal === '' || item.needTotal === undefined) {
                                    ...
                                    goArr = false
                                } else if (!ret.test(item.needTotal) || !ret.test(item.descTotal)) {
                                    this.$message({
                                        type: 'warning',
                                        message: '商品清单满足金额，赠送金额最多输入小数点后两位'
                                    }); 
                                    goArr = false
                        ...
                        if (goArr) {
                            ...
                            datas.isCtrlUseArea ? datas.isCtrlUseArea = 1 : datas.isCtrlUseArea = 0
                            this.presentPromotionAdd(datas).then((res) =>{
                                this.OnBackLatePage();
                            })
                        }
